...
const reviews = [
  {
    ...
    "review": "Excellent service and communication throughout the entire development process. Highly recommend!",
    "rating": 5,
  ...
  },
  {
    ...
    "review": "Their digital marketing strategies helped us boost our online visibility dramatically. Great results!",
    "rating": 4,
  ...
  },
  {
    ...
    "review": "The app development team delivered a top-notch product on time. Very professional and responsive.",
    "rating": 5,
  ...
  return (
    <div className=" overflow-hidden">
        ...
        <section className="max-w-6xl mx-auto">
          ...
          <div className='flex justify-center flex-wrap gap-4 md:gap-6 my-12'>
            {[
              ...
              <div key={index} className='bg-white rounded-full h-16 w-16 md:h-20 md:w-20 lg:h-24 lg:w-24 flex items-center justify-center shadow-md hover:shadow-lg transition-shadow'>
                <img className="h-8 md:h-10 w-auto" src={icon} alt={`icon-${index}`}/>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto mt-8 md:mt-16">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 px-4">
            <div className="w-full md:w-1/3 lg:w-1/4 transform hover:scale-105 transition-transform">
              <img 
                src='https://validthemes.net/site-template/landing-page/tekni/assets/img/demo/banner-1.jpg' 
                alt='demo' 
            ...
            <div className="w-full md:w-1/3 lg:w-2/4 z-10 transform hover:scale-105 transition-transform">
              <img 
                src='https://validthemes.net/site-template/landing-page/tekni/assets/img/demo/banner-center.jpg' 
                alt='demo' 
      ...
      <div className="bg-white py-12 md:py-20 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-[#20163c] font-bold text-lg uppercase tracking-wider mb-2">Why Choose Us</h2>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Save your time with a lot of features</h1>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We offer smart, flexible, and scalable solutions to help your business grow efficiently and effectively.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="flex justify-center mb-4">
                  <img src={feature.icon} alt={feature.title} className="h-16 w-auto"/>
                </div>
      ...
      <div className="bg-gray-50 py-12 md:py-20 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-[#20163c] font-bold text-lg uppercase tracking-wider mb-2">Testimonials</h2>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">What Our Clients Say</h1>
