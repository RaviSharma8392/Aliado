        ...
        <div className='max-w-sm'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-300'>
              We at OweBest Technologies would love to help you. Share your requirements and our dedicated team will get back to you with a custom solution and quotation tailored just for you.
            </p>
          </div>
        </div>
